...
import argparse
from bridge_controller_no_visual import DiffusionController
...
def parse_args():
    ...
    # Output arguments
    parser.add_argument("--task", type=str, default="cup",
                        help="Directory containing the dataset")
    parser.add_argument("--data_dir", type=str, default="./data/datasets/watercup_new_controller_40000",
                        help="Directory containing the dataset")

    parser.add_argument("--checkpoint_dir", type=str, default="residual_controller/checkpoint/bridge_controller_no_vision/",
